...
<div class="row">
	...
	<div class="container">
		<center>
			<h2 style="background-color:#fff;"><b><b>KAMI SIAP MELAYANI | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
			</h2>
		</center>
		<div class="columns">
			<ul class="price">
		...
		<div class="columns">
			<ul class="price" style="border-color: #777; box-shadow: 1px 2px 8px 2px rgba(0, 0, 0, 0.8);">
				...
				<li class="grey">
					<span>PEMBELIAN SPAPERPART / SUKU CADANG MOBIL</span>
				</li>
	...
	<footer class="text-center">BENGKEL TOGUMA MOTOR &copy; 2022</footer>
</div>
